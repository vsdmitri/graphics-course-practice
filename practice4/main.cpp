...
int main() try {
    ...
    const float top = height * right / width;
    const float camera_dz = 2.0f;
...
//    glCullFace(GL_FRONT);
    ...
    float speed = 1.f;
    float bunny_x = 0.f, bunny_y = 0.f;
    const float bunny1_offset_x = -1.0f, bunny1_offset_y = 0.45f;
    const float bunny2_offset_x = 0.5f, bunny2_offset_y = 0.55f;
    const float bunny3_offset_x = 0.5f, bunny3_offset_y = -0.55f;
    ...
    while (running) {
        ...
        float model1[16] =
                {
                        scale * c, 0.f, -s * scale, bunny1_offset_x + bunny_x,
                        0.f, scale, 0.f, bunny1_offset_y + bunny_y,
                        s * scale, 0.f, scale * c, 0.f,
                        0.f, 0.f, 0.f, 1.f,
                };
        ...
        float model2[16] =
                {
                        scale * c, -s * scale, 0.f, bunny2_offset_x + bunny_x,
                        s * scale, scale * c, 0.f, bunny2_offset_y + bunny_y,
                        0.f, 0.f, scale, 0.f,
                        0.f, 0.f, 0.f, 1.f,
                };
        ...
        float model3[16] =
                {
                        scale, 0.f, 0.f, bunny3_offset_x + bunny_x,
                        0.f, scale * c, -s * scale, bunny3_offset_y + bunny_y,
                        0.f, s * scale, scale * c, 0.f,
                        0.f, 0.f, 0.f, 1.f,
                };
